...
**Hvad:** `git mv projects/LIB.research projects/LIB.research` + arkivér forbrugte VPS-filer.

```bash
# Rename
git mv projects/LIB.research projects/LIB.research
...
**Opdatér refs i:**
- CONTEXT.md — `LIB.research/` → `LIB.research/`, `1_archive` → `9_archive`
- CLAUDE.md — verify `LIB.research/` i strukturen
- BLUEPRINT.md — `LIB.research/` → `LIB.research/`

...
**B: TransportIntra Arkiv** — Komplet projektmappe. Kildeindex allerede lavet: /root/Yggdra/REF.transportintra/TI_KOMPLET_KILDEINDEX.md (519 linjer, dækker ALLE kilder).
...
**Output:** `DLR.research-architecture/_audit.md` — tabel med [fil, kategori, one-line, størrelse]
...
**Output:** `DLR.research-architecture/INDEX.md` + `DLR.research-architecture/CONTEXT.md`
...
**Output:** `REF.transportintra/_scan/sessions.md` — kronologisk, med datoer
...
**Input:** PROGRESS.md + INDEX.md + TI_KOMPLET_KILDEINDEX.md + REF.transportintra/CONTEXT.md (eksisterende)
...
**Output:** `REF.transportintra/subprojects/*/CONTEXT.md` + `REF.transportintra/CONTEXT.md`

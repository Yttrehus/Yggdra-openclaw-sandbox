...
1. Audit /root/Yggdra/research/ — kategoriser 81 filer (duplikater, værdifulde, støj). Output: `DLR.research-architecture/_audit.md`
...
- `/root/Yggdra/REF.transportintra/` (CONTEXT.md, NOW.md)
...
1. **Scan-fase:** 3-4 parallelle Scanners:
   ...
   Output: én fundliste per scanner → `REF.transportintra/_scan/`. HVERT fund SKAL have dato (eller "ukendt dato"). Sortér kronologisk
...
### Scanner
"Gennemsøg [specifik kilde] for alt relateret til TransportIntra. Output: fundliste med [filsti, one-line summary, dato hvis mulig]. Skriv til REF.transportintra/_scan/[scanner-navn].md. Vær udtømmende."
...
# Projekt A
ssh root@72.62.61.51 "cat /root/Yggdra/yggdra-pc/DLR.research-architecture/INDEX.md"

# Projekt B
ssh root@72.62.61.51 "cat /root/Yggdra/yggdra-pc/REF.transportintra/INDEX.md"
ssh root@72.62.61.51 "ls /root/Yggdra/yggdra-pc/REF.transportintra/subprojects/"
